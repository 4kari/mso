...
public class BearingServiceFragmentK extends TechnicalFragment
    ...
    public static BearingServiceFragmentK newInstance(DetailInspection detailInspectionModel, Bearing bearingModel) {
    ...
    void populateFields() {
        ...
        try {
            etPoint.setText("K");
            checkValue(getData().getBearing().getA1(), etA1);
            checkValue(getData().getBearing().getA2(), etA2);
            checkValue(getData().getBearing().getB1(), etB1);
            checkValue(getData().getBearing().getB2(), etB2);
            checkValue(getData().getBearing().getB3(), etB3);
            checkValue(getData().getBearing().getC1(), etC1);
            checkValue(getData().getBearing().getC2(), etC2);
            checkValue(getData().getBearing().getC3(), etC3);
            checkValue(getData().getBearing().getD1(), etD1);
            checkValue(getData().getBearing().getD2(), etD2);
            checkValue(getData().getBearing().getD3(), etD3);
            checkValue(getData().getBearing().getE1(), etE1);
            checkValue(getData().getBearing().getE2(), etE2);
            checkValue(getData().getBearing().getE3(), etE3);
            checkValue(getData().getBearing().getF1(), etF1);
            checkValue(getData().getBearing().getF2(), etF2);
            checkValue(getData().getBearing().getF3(), etF3);
            checkValue(getData().getBearing().getG1(), etG1);
            checkValue(getData().getBearing().getG2(), etG2);
            checkValue(getData().getBearing().getH1(), etH1);
            checkValue(getData().getBearing().getH2(), etH2);
            checkValue(getData().getBearing().getI1(), etI1);
            checkValue(getData().getBearing().getI2(), etI2);
            checkValue(getData().getBearing().getJ1(), etJ1);
            checkValue(getData().getBearing().getJ2(), etJ2);
            checkValue(getData().getBearing().getK1(), etK1);
            checkValue(getData().getBearing().getK2(), etK2);
            checkValue(getData().getBearing().getL1(), etL1);
            checkValue(getData().getBearing().getL2(), etL2);
            checkValue(getData().getBearing().getM1(), etM1);
            checkValue(getData().getBearing().getM2(), etM2);
            clearNullDataInt(getData().getBearing().getJmlPenggantian(), etJmlPenggantian);
            clearNullData(getData().getBearing().getRunHours(), etRunHour);
            clearNullData(getData().getBearing().getRotor(), etRotor);
            clearNullData(getData().getBearing().getStator(), etStator);
            cbFilter.setChecked(isChecked(getData().getBearing().getFilter()));
            etKeteranganMMV.setText(getData().getBearing().getKeteranganMMV());
            initViewMembers(getData().getBearing().getMembers());
        }
    ...
    void setDataToModel() {
        ...
        if(!etI1.getText().toString().isEmpty())
            bearing.setI1(Double.parseDouble(etI1.getText().toString()));
