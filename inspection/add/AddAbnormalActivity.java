 ...
 */
public class AddAbnormalActivity extends BaseActivity
    ...
    public void setupAbnormalityStep(AbnormalityParams abnormalityParams) {
        ...
        if (mAdapter.getCount() < 4 && mBearingType == TYPE_MOTOR)
    ...
    public void onOfflineSave() {
        MaterialDialog dialog = new MaterialDialog.Builder(AddAbnormalActivity.this)
                .title("Simpan Data")
